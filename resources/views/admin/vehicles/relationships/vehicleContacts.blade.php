...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-vehicleContacts">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.contact.fields.vehicle') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-vehicleContacts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
