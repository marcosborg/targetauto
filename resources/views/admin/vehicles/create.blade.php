    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bodywork') ? 'is-invalid' : '' }}" type="text" name="bodywork" id="bodywork" value="{{ old('bodywork', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('power') ? 'is-invalid' : '' }}" type="text" name="power" id="power" value="{{ old('power', '') }}">
                @if($errors->has('power'))
                    <div class="invalid-feedback">
                        {{ $errors->first('power') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cylinder') ? 'is-invalid' : '' }}" type="text" name="cylinder" id="cylinder" value="{{ old('cylinder', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quilometers') ? 'is-invalid' : '' }}" type="text" name="quilometers" id="quilometers" value="{{ old('quilometers', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vat_margin') ? 'is-invalid' : '' }}" type="text" name="vat_margin" id="vat_margin" value="{{ old('vat_margin', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_consumption') ? 'is-invalid' : '' }}" type="text" name="average_consumption" id="average_consumption" value="{{ old('average_consumption', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('consumption_city') ? 'is-invalid' : '' }}" type="text" name="consumption_city" id="consumption_city" value="{{ old('consumption_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('highway_consumption') ? 'is-invalid' : '' }}" type="text" name="highway_consumption" id="highway_consumption" value="{{ old('highway_consumption', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('co_2_emissions') ? 'is-invalid' : '' }}" type="text" name="co_2_emissions" id="co_2_emissions" value="{{ old('co_2_emissions', '') }}">
